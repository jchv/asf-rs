...
impl<'a> StreamPropertiesData<'a> {
    ...
    pub fn size_of(&self) -> usize {
        ...
        len += 2;
        len += 4;
        len += self.type_specific_data.len();
...
mod tests {
    ...
    const BASIC_STREAM_PROPERTIES_BYTES: &'static [u8] = &[
        ...
        0x65, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9E, 0x69, 0xF8, 0x4D, 0x5B,
        0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B, 0x50, 0xCD, 0xC3, 0xBF, 0x8F,
        0x61, 0xCF, 0x11, 0x8B, 0xB2, 0x00, 0xAA, 0x00, 0xB4, 0xE2, 0x20, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x1C, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x01, 0x00, 0x70,
        0x33, 0x77, 0x00, 0x61, 0x01, 0x01, 0x00, 0x80, 0x3E, 0x00, 0x00, 0xD0, 0x07, 0x00, 0x00,
        0x80, 0x02, 0x10, 0x00, 0x0A, 0x00, 0x00, 0x22, 0x00, 0x00, 0x0E, 0x00, 0x80, 0x07, 0x00,
        0x00, 0x01, 0x80, 0x02, 0x80, 0x02, 0x01, 0x00, 0x00,
    ];
    ...
    fn parse_basic_stream_properties() {
        assert_eq!(
            HeaderObject::parse::<VerboseError<_>>(Span::new(BASIC_STREAM_PROPERTIES_BYTES))
                .expect("parse error")
                .1,
