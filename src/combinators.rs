use nom::{
    bytes::streaming::take, error::ParseError, IResult, InputIter, InputLength, InputTake, Parser,
    ToUsize,
};
...
pub fn span_bytes<'a, E, F>(
    mut f: F,
) -> impl FnMut(LocatedSpan<&'a [u8]>) -> IResult<LocatedSpan<&'a [u8]>, &'a [u8], E>
where
